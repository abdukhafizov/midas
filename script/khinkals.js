let dishes = [
    {
        id: Math.random(),
        menuImg: "../img/massiveDishes/khachapuri.svg",
...
let grids_of_khinkals_slide = document.querySelector(".grids_of_khinkals_slide")

for(let item of categories[0].khinkals){
    ...
    grids_of_khinkals_slide.append(dish)
