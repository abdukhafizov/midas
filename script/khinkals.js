...
axios.get("http://localhost:3002/khinkali").then(function (res) {
  let data = res.data;
  khinkals(data);
...
let grids_of_khinkals_slide = document.querySelector(
  ".grids_of_khinkals_slide"
);
// console.log(categories[0].hot);
function khinkals(arr) {
  for (let item of arr) {
